...
\par{\centering{\textbf{\LARGE Ayman Elmasry \small MSc, BSc, CEng, MCIBSE, MSFE}}\bigskip\par} % Your name
\vspace{-0.3cm}
\centering{\textsc{Phone:}  +44 7541 546823 \\
...
\textsc{Nov 2019} & Technical Manager at \textsc{HAZ International Ltd.}\\
...
\vspace{0.5cm}
\section{Professional Society Memberships, and Certificates}

\begin{tabular}{r|l}

\textsc{February} 2023 & \textsc{Engineering Council}\\
& \textsc{Chartered Engineer (CEng)}\\
& \textsc{Credential ID:  698313)}\\
\multicolumn{2}{c}{} \\

\textsc{December} 2022& \textsc{Chartered Institute of Building Services Engineers}\\
& \textsc{Member (MCIBSE)}\\
& \textsc{Credential ID:  063245)}\\
\multicolumn{2}{c}{} \\
...
\textsc{December} 2021& \textsc{Society of Facade Engineers}\\
& \textsc{Member (MSFE)}\\
& \textsc{Credential ID:  063245)}\\
\multicolumn{2}{c}{} \\
...
\\
Intermediate Knowledge: & Autodesk Revit, Physibel TRISCO, \\ 
& Rhinoceros 3D+Grasshopper, {\fb \LaTeX} (typesetting language)\\
\\
